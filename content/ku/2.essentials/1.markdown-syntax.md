---
title: ڕێزمانی Markdown
description: دەق، ناونیشان، و ستایلکردن بە markdown ی ستاندارد.
navigation:
...
ناونیشانەکان بەکاربهێنە بۆ ناساندنی بەشە سەرەکییەکان. ئەوان بەڵگەنامەکەت ڕێکدەخەن و یارمەتی بەکارهێنەران دەدەن لە گەڕان بە ناوەڕۆکدا.
