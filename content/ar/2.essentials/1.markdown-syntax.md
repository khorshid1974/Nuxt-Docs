...
description: النصوص، العناوين، والتنسيق باستخدام markdown القياسي.
navigation:
...
استخدم العناوين لتقديم الأقسام الرئيسية. فهي تنظم توثيقك وتساعد المستخدمين على التنقل في المحتوى.
